...
less.modifyVars = function(record) {
    ...
    new(less.Parser)().parse(session_cache, function (e, root) {
...
function loadStyleSheets(callback, reload) {
	...
	var cachedCSSRules = cache.getItem('bootstrap:achauhan-parsed-less');
	if(cachedCSSRules!=null){
		session_cache = cachedCSSRules;
	}
}
...
function createCSS(styles, sheet, lastModified) {
    ...
    if (lastModified && cache) {
		...
		cache.setItem('bootstrap:achauhan-parsed-less',session_cache);
